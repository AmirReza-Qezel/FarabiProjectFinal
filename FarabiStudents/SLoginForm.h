...
namespace FarabiStudents {
	...
	/// <summary>
	/// Summary for SLoginForm
	/// </summary>
	public ref class SLoginForm : public System::Windows::Forms::Form
	{
	public:
		SLoginForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->loginbtn->Click += gcnew System::EventHandler(this, &SLoginForm::loginbtn_Click);
			// 
			// label2
			// 
			...
			this->Name = L"SLoginForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"SLoginForm";
...
private: System::Void loginbtn_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	else if (userName == "ordinaryemployeeoffarabi" && password == "5678")
	{
		isLoginValid = true;
		this->Close();
	}
